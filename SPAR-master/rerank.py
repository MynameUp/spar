...
class Reranker(object):
    def rerank_query_and_doc_list(self,all_docs,user_query,score_name="sim_score"):
        ...
        try:
            ...
            # Update original docs' sim_score with rerank_score
    ...
    def _update_documents_with_reranking(self, reranked_results, original_docs):
        ...
        Modifies original docs in-place by setting sim_score = rerank_score / 10.
        """
        ...
        for idx, result in enumerate(reranked_results):
            if idx < len(original_docs):
                ...
                if rerank_score is not None:
                    ...
                    # 将 rerank_score (0-10) 归一化到 0-1 并更新 sim_score
                    doc["sim_score"] = rerank_score / 10.0
                    doc["rerank_score"] = rerank_score
                    doc["rerank_justification"] = justification
                    updates_applied += 1
